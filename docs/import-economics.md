...
- Subscription status controls Recallly intelligence. Import Credits control new external knowledge. Downgrading does not remove credits. Enrichment failure does not refund a successfully imported item.
